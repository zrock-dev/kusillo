...
use crate::database::game_match::utils::{retrieve_score_value, update_game_set};
...
#[tauri::command]
pub fn fire_score_update(app_handle: AppHandle, game_id: i64, team_id: i64, max_score: i64) -> Result<(), Error> {
...
pub fn publish_game_update(app_handle: &AppHandle, configuration: GameUpdate, team_id: i64, score_points: i64) -> Result<(), Error> {
